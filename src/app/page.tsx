...
export default function Home() {
  return (
    <div id="home" className="page mb-8">
      ...
      <div id="home-content">
        ...
        <h3 className="text-xl">
        We run semester-long introductory programs on AI safety, including a technical and policy track. <a href="/programs" className="underline">Learn more and apply here by February 14th.</a>
        </h3>
        <h3 className="text-xl">

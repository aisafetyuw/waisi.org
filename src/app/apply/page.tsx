...
export const metadata: Metadata = {
  ...
  description:
    "Apply to the WAISI Fellowship — an eight-week reading group on technical AI safety or AI governance.",
};
    ...
    <div id="apply" className="-mx-10">
      <div className="mx-auto max-w-3xl px-6 py-10 sm:px-8">
        ...
        <p className="mt-2 max-w-prose text-base text-primary">
          Eight weeks, two hours a week — technical AI safety or AI governance.

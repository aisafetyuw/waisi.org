          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3">
                <p className="text-lg" style={{color: '#2D2A26', fontFamily: '"DM Serif Display", serif'}}>Learn the basics of AI safety and how to prevent harm from AI systems in an eight-week reading group. WAISI offers two intro tracks, focusing on technical and policy respectively. Applications are open at the beginning of each semester, and we recommend applying to the program you are most interested in. You can participate in both tracks simultaneously.</p>
                <p className="text-lg" style={{color: '#2D2A26', fontFamily: '"DM Serif Display", serif'}}>Participants meet every week to read material, complete interactive activities, and participate in discussions. Each session runs for 2 hours, with at most 1 hour of preparation work assigned prior to each session. For full details, review the handbook <a href="https://docs.google.com/document/d/1nlA0I7yGo7e7tC6xS8kBQUuyil88xrYji5KPeyUPRwA/edit?usp=sharing" target="_blank" style={{color: '#8B5CF6', textDecoration: 'none'}} className="hover:underline">here.</a></p>
              </div>
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
                <div>
                  <h3 className="text-2xl font-semibold" style={{color: '#6B46C1', borderBottom: '2px solid #E8DCC8', paddingBottom: '4px', fontFamily: '"DM Serif Display", serif'}}>Technical Fundamentals</h3>
                  <div className="flex flex-col gap-3 mt-3">
                    <p className="text-lg" style={{color: '#2D2A26', fontFamily: '"DM Serif Display", serif'}}>The technical track of AI Safety Fundamentals is an eight-week research-oriented reading group on technical AI safety. Topics include reward specification, generalization, interpretability, unlearning, and career explorations.
                    </p>
                    {/* <p className="text-lg">
                    ...
                    <p className="text-lg" style={{color: '#2D2A26', fontFamily: '"DM Serif Display", serif'}}>Students with machine learning experience are especially encouraged to apply, although <b style={{color: '#6B46C1'}}>no prior experience is needed.</b></p>
                    <p className="text-xl font-semibold" style={{color: '#6B46C1', fontFamily: '"DM Serif Display", serif'}}><a href="https://forms.gle/pPn5idt81BEDH8bG8" target="_blank" style={{color: '#8B5CF6', textDecoration: 'none'}} className="hover:underline">Apply here by this Sunday, September 21st, 11:59 PM CST. →</a></p>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center">
                  <Zoom>
                    <Image
                      ...
                      width={324}
                      height={486}
                      className="w-full h-auto max-w-sm" style={{backgroundColor: '#FFF9F0'}}
                    />
                  </Zoom>
                  <p className="mt-2 text-center text-sm" style={{color: '#2D2A26', fontFamily: '"DM Serif Display", serif'}}>Click to expand!</p>
                </div>

                <div>
                  <h3 className="text-2xl font-semibold" style={{color: '#6B46C1', borderBottom: '2px solid #E8DCC8', paddingBottom: '4px', fontFamily: '"DM Serif Display", serif'}}>Policy Fundamentals</h3>
                  <div className="flex flex-col gap-3 mt-3">
                    <p className="text-lg" style={{color: '#2D2A26', fontFamily: '"DM Serif Display", serif'}}>
                    ...
                    <p className="text-xl font-semibold" style={{color: '#6B46C1', fontFamily: '"DM Serif Display", serif'}}><a href="https://forms.gle/bcRimCCmg7F3uEaS9" target="_blank" style={{color: '#8B5CF6', textDecoration: 'none'}} className="hover:underline">Apply here by Sunday, February 21st, 11:59 PM CST. →</a></p>
                  </div>
                </div>
              </div>
            </div>
